...
print("מרונדם: ",data)
sort_a = sorted(data, key=lambda t: t[0])
print("ממוין לפי הערך ה1: ",sort_a)
sort_b = sorted(data, key=lambda t: t[1])
print("ממוין לפי הערך השני: ",sort_b)
sort_c = sorted(data, key=lambda t: t[2])
print("ממוין לפי הערך השלישי: ",sort_c)
